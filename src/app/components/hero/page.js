...
export default function Hero() {
  return (
    <div className="flex justify-center">
      ...
      <img src="assets/images/hero-text.svg" className="absolute z-30 mt-12 top-24 sm:mb-0 lg:text-8xl max-w-[86vw] sm:max-w-max lg:min-w-[40rem]" alt="Girl in a jacket" width="500" height="600"></img>
      <div
